...
class LdapClient extends EventEmitter {
    ...
    bind(name, credentials, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.bind(name, credentials, controls, (error, result) => {
                if (error) {
    ...
    add(name, entry, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.add(name, entry, controls, (error, result) => {
                if (error) {
    ...
    del(name, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.del(name, controls, (error, result) => {
                if (error) {
    ...
    modify(name, change, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.modify(name, change, controls, (error, result) => {
                if (error) {
    ...
    modifyDN(name, newName, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.modifyDN(name, newName, controls, (error, result) => {
                if (error) {
