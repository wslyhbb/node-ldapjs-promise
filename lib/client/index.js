...
class LdapClient {
    ...
    abandon(messageID, controls) {
        ...
        return new Promise(resolve => {
            this.client.abandon(messageID, controls, error => {
                ...
                log.trace('abandon successful for: %s', messageID);
                return resolve();
            });
        });
    }
    ...
    add(name, entry, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.add(name, entry, controls, error => {
                ...
                log.trace('add successful for: %s', name);
                return resolve();
            });
        });
    }
    ...
    compare(name, attr, value, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.compare(name, attr, value, (error, matched) => {
                if (error) {
    ...
    exop(name, value, controls) {
        ...
        return new Promise((resolve, reject) => {
            this.client.exop(name, value, (error, resValue, response) => {
                if (error) {
