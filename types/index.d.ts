...
export interface Client extends EventEmitter {
     ...
     * @throws {TypeError} on invalid input.
     */
    add(name: string, entry: Object, controls?: Control | Control[]): Promise<void>;
     ...
     * @throws {TypeError} on invalid input.
     */
    del(name: string, controls?: Control | Control[]): Promise<void>;

    /**
     * Performs an extended operation on the LDAP server.
     *
     * Pretty much none of the LDAP extended operations return an OID
     * (responseName), so it is not returned as a separate parameter.
     ...
     * @throws {TypeError} on invalid input.
     */
    exop(name: string, value: string | Buffer, controls?: Control | Control[]): Promise<{
        value: string,
        response: any
    }>;
     ...
     * @throws {TypeError} on invalid input.
     */
    modifyDN(name: string, newName: string, controls?: Control | Control[]): Promise<void>;
    ...
    /**
     * Performs an LDAP search against the server and returns all results.
     * 
     ...
     */
    starttls(options: Object, controls?: Control | Control[], _bypass?: boolean): Promise<void>;
